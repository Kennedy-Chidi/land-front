  ...
  methods: {
    ...
    processTransaction() {
      ...
      if (!this.wallet || this.wallet == undefined) {
        this.showResponseMsg(
          "Please select a wallet address for this transaction",
          false
        );
        return;
      }
      ...
      if (
        ...
        this.showResponseMsg(
          "Sorry, the select wallet has insufficient fund for this transaction",
          false
        );
        return;
      }
      ...
      if (this.plan == "") {
        this.showResponseMsg(
          "please select a plan for this transaction",
          false
        );
        return;
      }
    ...
    async createTransaction(form) {
      ...
      try {
        ...
        this.getTransactions();
        this.cleareInputs();
        this.showResponseMsg("The transaction was created successfully.", true);
      } catch (err) {
